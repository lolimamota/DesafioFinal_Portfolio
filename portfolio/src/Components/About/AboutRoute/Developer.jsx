...
function Developer() {
  ...
  return (
    ...
    <S.DivDev>
      <S.AnchorTag href="https://github.com/lolimamota">
        <img src={GitHub} alt="Logo do github" />
      </S.AnchorTag>

    <S.AnchorTag href="https://www.linkedin.com/in/lorraynelimamota/">
      <img src={LinkedIn} alt="logo do LinkedIn" />
    </S.AnchorTag>

    <S.AnchorTag href="https://api.whatsapp.com/send/?phone=%2B5531992539210&text&type=phone_number&app_absent=0">
